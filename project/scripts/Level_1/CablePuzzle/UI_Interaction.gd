...
@export var spot_id       : String = "pipe_puzzle"
@export var target_scene  : String = "res://scenes/Level1/puzzles/PipePuzzle/PipePuzzle.tscn"
...
func _is_solved() -> bool:
	...
	return puzzles.get("pipe_puzzle", false)
